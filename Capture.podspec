#
#  Be sure to run `pod spec lint Capture.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Sanwal, Manish" => "Manish.Sanwal@gmail.com" }
  # Or just: s.author    = "Sanwal, Manish"
  # s.authors            = { "Sanwal, Manish" => "Manish.Sanwal@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Sanwal, Manish"
  ...
  s.dependency "RxTest", "~> 3.6.1"
  s.dependency "SwiftLint", "~> 0.22.0"
